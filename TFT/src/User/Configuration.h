...
*/
#define STARTUP_KNOB_LED_COLOR 6         // LED_OFF - 6 color Green
 ...
 *
 */
#define DEFAULT_LCD_BRIGHTNESS      8  // 11: LCD_100_PERCENT - Brightness value from list
...
#define EXTRUDE_NORMAL_SPEED    150
...
#define NOZZLE_PAUSE_E_FEEDRATE     150 // (mm/min) retract & purge feedrate
